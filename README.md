...
× firmware Kp 4, 8, 12, 16) used to identify `bam/params/feetech_hls`.
...
JSON as `bam/params/feetech_hls` on `feature/feetech-hls`).
...
python3 -m bam.fit --logdir proc --actuator feetech_hls --model m5 \
